...
export function SettingsTab({ isMobile = false }: { isMobile?: boolean }) {
  ...
  useEffect(() => {
    localStorage.setItem('smart_care_email_enabled', emailEnabled.toString());
    localStorage.setItem('smart_care_email_receiver', emailReceiver);
  }, [emailEnabled, emailReceiver]);
